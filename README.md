...
[Модифицированая сборка](https://github.com/luxplanjay/gulp-starter-kit)
...
- Автоматическая конвертация в WebP, в дополнение к стандартным картинкам
  **_(only build)_**
...
```shell
git clone https://github.com/luxplanjay/gulp-starter-kit.git имя_проекта
```
